...
__version__ = '1.0'
for line in file(os.path.join('Object3D', 'SceneGLWindow.py')).readlines():
...
data_files = [('Object3D', ['LICENSE.GPL',]),
              (os.path.join('Object3D', 'Object3DPlugins'),
               glob.glob(os.path.join('Object3D', 'Object3DPlugins','*.py'))) ]
...
def build_Object3DCTools(ext_modules):
    print "sources = ", glob.glob('Object3D/Object3DCTools/*.c')
    ...
    module  = Extension(name = 'Object3D.Object3DCTools',
                        sources = glob.glob('Object3D/Object3DCTools/*.c'),
...
def build_Object3DQhull(ext_modules):
    module  = Extension(name = 'Object3D.Object3DQhull',
                        sources = glob.glob('Object3D/Object3DQhull/src/*.c'),
                        define_macros = define_macros,
...
class smart_install_scripts(install_scripts):
    def run (self):
        ...
        self.outfiles = []
        for filein in glob.glob('Object3D/scripts/*'):
